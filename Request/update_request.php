...
require '../Backend/db.php'; // Gagamit ng iyong $conn at logActivity function
...
if ($stmt->execute()) {
    ...
    $info_sql = "SELECT p.email FROM personnel p 
                 JOIN access_requests ar ON p.id = ar.user_id 
                 WHERE ar.id = ?";
