...
require '../Backend/db.php'; // I-check ang tamang path

// Security Check: Siguraduhing Admin ang naka-login (I-adjust base sa role logic mo)
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'admin') {
    // Kung wala ka pang 'role' checking, tanggalin ang `|| $_SESSION['role'] !== 'admin'` pansamantala para sa testing.
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    try {
        ...
        $query = "
            ...
            JOIN personnel p ON r.user_id = p.id
